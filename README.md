...
Este documento y el cuaderno `Examen2-Gutierrez-Rendon.ipynb` corresponden a la entrega del examen de Matemáticas Aplicadas. El objetivo no es solo llegar a una solución numérica, sino entender qué hace cada paso y por qué se hace. Por eso, tanto aquí como en el cuaderno, se ha procurado que cada sección vaya acompañada de una explicación en lenguaje natural, evitando saltos abruptos entre bloques.
